...
count = 0
while True:
    for accuant in [avisoooo,]: #,  firefo, pinkfloyd,]: # [avisoooo]: # [avisoooooo, firefo, pinkfloyd, avisoooo]:
        # search squerYoutube
        ...
        check = list(p.locateAll( "allow_form.png", accuant["screenshoot"], confidence=0.8))
        if check != []:
            print("allow_form move and click ", check)
        ...
        if squerYoutube != []:
            ...
            p.moveTo(accuant["screen_x"] + squerYoutube[0][0] + squerYoutube[0][2] + 13, accuant["screen_y"]+ squerYoutube[0][1] + 10, 0.5)
        ...
        if heart_first_png != []:
            ...
            p.moveTo(accuant["screen_x"] + heart_first_png[0][0] + heart_first_png[0][2] + 10, accuant["screen_y"] +  heart_first_png[0][1] + 10, 0.5)
        ...
        if picYoutube != []:
            ...
            p.moveTo(accuant["screen_x"] + picYoutube[0][0]+picYoutube[0][2]+15 , accuant["screen_y"] + picYoutube[0][1]+10, 0.5)
        ...
        # update firefo
        aviso.update_screenshoot()
        for pic in ["order_not_found.png", "no_access.png", "no_balance.png", "no_pay.png", "no_task.png"]:
        ...
        if youtube_play_red_ico != []:
            ...
            p.moveTo(accuant["screen_x"] + youtube_play_red_ico[0][0], accuant["screen_y"] +  youtube_play_red_ico[0][1], 0.4)
            p.click()
            continue
        ...
        if youtube_play_dark_ico != []:
            ...
            p.moveTo(accuant["screen_x"] + youtube_play_dark_ico[0][0], accuant["screen_y"] + youtube_play_dark_ico[0][1], 0.4)
            p.click()
            continue
        ...
        if play_minimal_ico != []:
            ...
            p.moveTo(accuant["screen_x"] + play_minimal_ico[0][0]+5, accuant["screen_y"] +  play_minimal_ico[0][1]+5, 0.4)
            p.click()
            continue
        ...
        if youtube_lable_ico != []:
            ...
            print("NOT Found youtube_lable_ico ------------------------")
        ...
        aviso.update_screenshoot()
        page_youtube_check_title = list(p.locateAll("page_youtube_check_title.png", accuant["screenshoot"], confidence=0.8))
        if page_youtube_check_title != []:
            ...
            if check_title != []:
                print("search check_title fined, close page", accuant["check_title"])
                p.moveTo(accuant["screen_x"] + page_youtube_check_title[0][0] + 15, accuant["screen_y"] + page_youtube_check_title[0][1] + 15, 0.7)
                p.click()
                s(0.1)
                aviso.close_page()
