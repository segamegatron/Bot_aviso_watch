...
class BAviso:
    ...
    def search_all_pic_screen(self, pic):
        return [match for match in p.locateAllOnScreen(pic, confidence=0.9)]
                ...
                if self.continue_more:
                    ...
                    if pic == "picYoutube.png":
                        ...
                        if self.continue_more:
                            ...
                            # self.check_ico([self.my_pay_from_youtube, self.order_not_found], count=3)
                            # if self.continue_more:
                            #     self.close_page()
                    #
